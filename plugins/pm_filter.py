...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 💥 ,\n\nur Movie {content} Direct File Will be available in Below Bot 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🍿 Ur Movie File Ask Here 🍿", url=f"https://t.me/Theater_Print_Movies_Search_bot")]])
    )
